...
def job(num_gpus, base_model, train_file, validation_file, finetuned_id, num_train_epochs, gradient_accumulation_steps, per_device_train_batch_size):
    ...
    --learning_rate 5e-06 \
    --warmup_steps 10'''.format(num_gpus, base_model, train_file, validation_file, finetuned_id, num_train_epochs, gradient_accumulation_steps, per_device_train_batch_size)
